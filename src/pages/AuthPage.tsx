            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {!isLogin && (
                <div className="space-y-1.5">
                  <label className="text-sm font-medium">{t('auth.display_name')}</label>
                  <Input
                    value={displayName}
              ...
              <Button type="submit" className="w-full" disabled={loading}>
                {loading ? <Loader2 className="h-4 w-4 animate-spin" /> : (isLogin ? t('auth.login_btn') : t('auth.signup_btn'))}
              </Button>
            </form>
